...
public class LivreDaoImpl implements ILivreDao {
    ...
    private final  String FIND_ALL = "SELECT l.id, titre, isbn, qnt, auteur_id, a.name, a.lastName, a.nationalite, a.date_naissance FROM livre AS l INNER JOIN auteur as a ON a.id = l.id ";
